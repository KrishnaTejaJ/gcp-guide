...
import { 
  ...
  Bug, LineChart, Code, Shield, KeyRound, Share2, MessageSquare, AudioLines, Scan,
  Boxes, Globe, Layers, Activity, Terminal, ExternalLink, Lock
} from 'lucide-react';
                ...
                <div className="flex justify-between items-start mb-6">
                  <div className="p-3 bg-blue-50 rounded-2xl text-blue-700 group-hover:bg-blue-700 group-hover:text-white transition-all shadow-sm">
                    {item.id.includes('bigquery') ? <BarChart3 size={28} /> : 
                     ...
                     item.id.includes('trace') ? <Scan size={28} /> :
                     <Database size={28} />}
                  </div>
